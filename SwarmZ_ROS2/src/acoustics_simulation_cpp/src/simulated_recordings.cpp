...
public:
  ...
  : Node("minimal_publisher"), count_time(0)
  {
    ...
    // source_01_publisher_  = this->create_publisher<std_msgs::msg::Float32>("/px4_1/fmu/in/monoSoundSensor",10);
    // source_02_publisher_  = this->create_publisher<std_msgs::msg::Float32>("/px4_2/fmu/in/monoSoundSensor",10);
    // source_03_publisher_  = this->create_publisher<std_msgs::msg::Float32>("/px4_3/fmu/in/monoSoundSensor",10);
    // source_04_publisher_  = this->create_publisher<std_msgs::msg::Float32>("/px4_4/fmu/in/monoSoundSensor",10);
    // source_05_publisher_  = this->create_publisher<std_msgs::msg::Float32>("/px4_5/fmu/in/monoSoundSensor",10);
...
private:  
  ...
  void timer_callback()
  {
    ...
    s_total_to_r1 = s_motor_to_r1;
    s_total_to_r2 = s_motor_to_r2;
    s_total_to_r3 = s_motor_to_r3;
    s_total_to_r4 = s_motor_to_r4;
    s_total_to_r5 = s_motor_to_r5;
